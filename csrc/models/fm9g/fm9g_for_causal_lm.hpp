...
// FM9GForCausalLM: extends PiecewiseTextCausalLM, sets MuP alpha on lm_head
class FM9GForCausalLM : public infinilm::layers::causal_lm_templates::PiecewiseTextCausalLM<FM9GModel> {
public:
    FM9GForCausalLM(std::shared_ptr<infinilm::config::ModelConfig> model_config,
                    const infinicore::Device &device)
        : PiecewiseTextCausalLM<FM9GModel>(model_config, device) {
