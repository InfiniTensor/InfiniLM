...
class DeepseekV4Gate : public infinicore::nn::Module {
public:
    DeepseekV4Gate(std::shared_ptr<infinilm::config::ModelConfig> model_config,
...
private:
    INFINICORE_NN_MODULE(DeepseekV4Gate, gate);
