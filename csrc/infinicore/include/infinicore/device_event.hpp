...
class DeviceEvent {
private:
    infini::rt::runtime::Event event_ = nullptr; // Underlying event handle
...
public:
     ...
     */
    void record(infini::rt::runtime::Stream stream);
     ...
     */
    void wait(infini::rt::runtime::Stream stream = nullptr) const;
     ...
     */
    infini::rt::runtime::Event get() const { return event_; }
