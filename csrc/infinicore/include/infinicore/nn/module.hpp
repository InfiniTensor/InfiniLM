...
public:
    ...
    void load_parameters_no_sync(const std::unordered_map<std::string, Tensor> &params, bool strict = true);
 ...
 *           INFINICORE_NN_PARAMETER_INIT(scaling_factor, ({1}, DataType::kFloat32, Device()));
 *       }
 *   };
 * @endcode
 */
...
// Example: INFINICORE_NN_PARAMETER_INIT(weight, ({out_features, in_features}, DataType::kFloat32, device))
...
// Example: INFINICORE_NN_BUFFER_INIT(cache, ({max_seq_len, head_dim}, DataType::kFloat32, device))
