...
inline void log_tensor_stats(const infinicore::Tensor &tensor, const std::string &name,
    ...
    if (dtype == infinicore::DataType::kFloat32 || dtype == infinicore::DataType::kFloat16 || dtype == infinicore::DataType::kBFloat16) {
        // Copy to CPU if needed and compute stats
        auto cpu_tensor = tensor->to(infinicore::Device(infinicore::Device::Type::kCpu, 0));
        ...
        if (numel > 0) {
            ...
            } else if (dtype == infinicore::DataType::kFloat16) {
            ...
            } else if (dtype == infinicore::DataType::kBFloat16) {
