...
using AttentionImpl = std::variant<std::shared_ptr<backends::StaticAttentionImpl>, std::shared_ptr<backends::PagedAttentionImpl>, std::shared_ptr<backends::FlashAttentionImpl>, std::shared_ptr<backends::FlashInferAttentionImpl>>;
...
public:
    AttentionLayer(size_t num_heads,
        ...
        case ::infinilm::backends::AttentionBackend::FLASHINFER:
            ...
            break;
        default:
            throw std::runtime_error("AttentionLayer: unsupported attention backend");
        }
    }
