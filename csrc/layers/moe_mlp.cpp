...
MoeMLP::MoeMLP(std::shared_ptr<infinilm::config::ModelConfig> model_config, // TODO: 传入量化config, 这样的话 MoeMLP 和 MLP可以复用
               const infinicore::Device &device,
               engine::distributed::RankInfo rank_info)
    : hidden_size_(model_config->get<size_t>("hidden_size")),
      moe_intermediate_size_(model_config->get<size_t>("moe_intermediate_size")), rank_info_(rank_info) {
