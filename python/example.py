...
"""
CLI:
 python /home/zhushuang/InfiniLM/python/example.py --model-path /data-aisoft/mechdancer/models/9G7B_MHA --device-type nvidia --ndev 1 --max-kvcache-tokens 10240 --enable-paged-attn
