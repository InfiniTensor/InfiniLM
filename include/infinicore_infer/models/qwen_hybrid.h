...
__C __export struct QwenHybridCache *createQwenHybridCache(
    size_t nlayers,
    size_t max_len,
    size_t nkvh_,
    size_t dk,
...
__C __export void dropQwenHybridCache(struct QwenHybridCache *cache);
...
/// @param hybrid_caches 每个请求的 KV/Mamba Cache
...
inferBatchQwenHybrid(struct QwenHybridModel *,
                     ...
                     struct QwenHybridCache **hybrid_caches,
...
__C __export void
forwardBatchQwenHybrid(struct QwenHybridModel *,
                       const uint32_t *tokens, uint32_t ntok,
                       const uint32_t *req_lens, uint32_t nreq, const uint32_t *req_pos,
                       struct QwenHybridCache **hybrid_caches,
                       void *logits);
