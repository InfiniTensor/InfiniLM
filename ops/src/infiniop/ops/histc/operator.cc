...
#include "cpu/histc_cpu.h"
#endif
#if defined(ENABLE_NVIDIA_API) || defined(ENABLE_QY_API)
#include "nvidia/histc_nvidia.cuh"
#endif
#ifdef ENABLE_METAX_API
#include "metax/histc_metax.h"
#endif
...
#define GET(CASE, NAMESPACE)                                                                 \
    case CASE:                                                                               \
        *size = reinterpret_cast<op::histc::NAMESPACE::Descriptor *>(desc)->workspaceSize(); \
