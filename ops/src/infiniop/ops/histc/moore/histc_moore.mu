...
infiniStatus_t Descriptor::calculate(
    ...
    CHECK_MOORE(musaMemsetAsync(y, 0, _bins * sizeof(float), musa_stream));
    ...
    case INFINI_DTYPE_F16:
        cuda::histc_kernel<half><<<num_blocks, BLOCK_SIZE, 0, musa_stream>>>(
    ...
    case INFINI_DTYPE_BF16:
        cuda::histc_kernel<cuda_bfloat16><<<num_blocks, BLOCK_SIZE, 0, musa_stream>>>(
            reinterpret_cast<float *>(y),
    ...
    case INFINI_DTYPE_F32:
        cuda::histc_kernel<float><<<num_blocks, BLOCK_SIZE, 0, musa_stream>>>(
            reinterpret_cast<float *>(y),
    ...
    case INFINI_DTYPE_F64:
        cuda::histc_kernel<double><<<num_blocks, BLOCK_SIZE, 0, musa_stream>>>(
            reinterpret_cast<float *>(y),
