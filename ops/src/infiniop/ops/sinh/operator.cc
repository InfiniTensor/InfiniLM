...
__INFINI_C infiniStatus_t infiniopCreateSinhDescriptor(
...
__INFINI_C infiniStatus_t infiniopGetSinhWorkspaceSize(infiniopSinhDescriptor_t desc, size_t *size) {
...
__INFINI_C infiniStatus_t infiniopSinh(
