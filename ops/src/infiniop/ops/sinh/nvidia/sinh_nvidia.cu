...
infiniStatus_t Descriptor::calculate(
    ...
    case INFINI_DTYPE_BF16:
        return _device_info->calculate<256, cuda::SinhOp, cuda_bfloat16>(_info, workspace, output, inputs, stream);
    case INFINI_DTYPE_F32:
        return _device_info->calculate<256, cuda::SinhOp, float>(_info, workspace, output, inputs, stream);
    case INFINI_DTYPE_F64:
        return _device_info->calculate<256, cuda::SinhOp, double>(_info, workspace, output, inputs, stream);
    default:
