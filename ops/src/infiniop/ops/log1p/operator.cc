...
#define CREATE(CASE, NAMESPACE)                                              \
    case CASE:                                                               \
        return op::log1p::NAMESPACE::Descriptor::create(                     \
            handle,                                                          \
            reinterpret_cast<op::log1p::NAMESPACE::Descriptor **>(desc_ptr), \
            y_desc,                                                          \
            {x_desc})
...
#define GET(CASE, NAMESPACE)                                                                 \
    case CASE:                                                                               \
        *size = reinterpret_cast<op::log1p::NAMESPACE::Descriptor *>(desc)->workspaceSize(); \
...
#define CALCULATE(CASE, NAMESPACE)                                              \
    case CASE:                                                                  \
        return reinterpret_cast<const op::log1p::NAMESPACE::Descriptor *>(desc) \
...
#define DELETE(CASE, NAMESPACE)                                                  \
    case CASE:                                                                   \
        delete reinterpret_cast<const op::log1p::NAMESPACE::Descriptor *>(desc); \
        return INFINI_STATUS_SUCCESS;
