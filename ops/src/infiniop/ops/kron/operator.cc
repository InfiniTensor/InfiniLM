...
#include "cpu/kron_cpu.h"
#endif
#if defined(ENABLE_NVIDIA_API) || defined(ENABLE_QY_API)
#include "nvidia/kron_nvidia.cuh"
#endif
#ifdef ENABLE_METAX_API
#include "metax/kron_metax.h"
#endif
...
#define CREATE(CASE, NAMESPACE)                                             \
    case CASE:                                                              \
        return op::kron::NAMESPACE::Descriptor::create(                     \
            handle,                                                         \
            reinterpret_cast<op::kron::NAMESPACE::Descriptor **>(desc_ptr), \
            y_desc,                                                         \
            a_desc,                                                         \
            b_desc)
...
#define CALCULATE(CASE, NAMESPACE)                                             \
    case CASE:                                                                 \
        return reinterpret_cast<const op::kron::NAMESPACE::Descriptor *>(desc) \
...
#define DELETE(CASE, NAMESPACE)                                                 \
    case CASE:                                                                  \
        delete reinterpret_cast<const op::kron::NAMESPACE::Descriptor *>(desc); \
        return INFINI_STATUS_SUCCESS;
