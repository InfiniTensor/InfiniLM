...
infiniStatus_t Descriptor::calculate(
    ...
    case INFINI_DTYPE_F16:
        cuda::kron_kernel<half><<<num_blocks, BLOCK_SIZE, 0, musa_stream>>>(
    ...
    case INFINI_DTYPE_BF16:
        cuda::kron_kernel<cuda_bfloat16><<<num_blocks, BLOCK_SIZE, 0, musa_stream>>>(
    ...
    case INFINI_DTYPE_F32:
        cuda::kron_kernel<float><<<num_blocks, BLOCK_SIZE, 0, musa_stream>>>(
    ...
    case INFINI_DTYPE_F64:
        cuda::kron_kernel<double><<<num_blocks, BLOCK_SIZE, 0, musa_stream>>>(
