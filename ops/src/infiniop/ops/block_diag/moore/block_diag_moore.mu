...
infiniStatus_t Descriptor::calculate(
    ...
    CHECK_MOORE(musaMemcpyAsync(d_input_stride0, input_stride0.data(), num_inputs * sizeof(ptrdiff_t), musaMemcpyHostToDevice, musa_stream));
    CHECK_MOORE(musaMemcpyAsync(d_input_stride1, input_stride1.data(), num_inputs * sizeof(ptrdiff_t), musaMemcpyHostToDevice, musa_stream));
