...
public:
    ...
    static std::shared_ptr<SelfAttention> init(infiniDtype_t dtype, size_t hidden_size, size_t n_q_heads, size_t n_kv_heads, size_t qk_head_dim, size_t v_head_dim, int nranks = 1, bool has_qkv_bias = false, bool has_qk_norm = false);
