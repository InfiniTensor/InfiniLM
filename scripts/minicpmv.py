...
def _build_vision_model(model_dir: Path, torch_dt_logits, dt_logits: DataType):
...
def main():
    ...
    vision_torch_dt = torch.float32 if args.vision_f32 else llm_torch_dt
    vision_dt = DataType.INFINI_DTYPE_F32 if args.vision_f32 else llm_dt
