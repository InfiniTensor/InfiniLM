...
class JiugeWeightsCStruct(ctypes.Structure):
    _fields_ = [
        ...
        ("dt_qzeros", DataType),
        ("dt_g_idx", DataType),
        ("attn_qkv_qweight", POINTER(c_void_p)),
        ("attn_qkv_scales", POINTER(c_void_p)),
        ("attn_qkv_qzeros", POINTER(c_void_p)),
        ("attn_qkv_g_idx", POINTER(c_void_p)),
        ("attn_o_qweight", POINTER(c_void_p)),
        ("attn_o_scales", POINTER(c_void_p)),
        ("attn_o_qzeros", POINTER(c_void_p)),
        ("attn_o_g_idx", POINTER(c_void_p)),
        ("ffn_gate_up_qweight", POINTER(c_void_p)),
        ("ffn_gate_up_scales", POINTER(c_void_p)),
        ("ffn_gate_up_qzeros", POINTER(c_void_p)),
        ("ffn_gate_up_g_idx", POINTER(c_void_p)),
        ("ffn_down_qweight", POINTER(c_void_p)),
        ("ffn_down_scales", POINTER(c_void_p)),
        ("ffn_down_qzeros", POINTER(c_void_p)),
        ("ffn_down_g_idx", POINTER(c_void_p)),
    ]
